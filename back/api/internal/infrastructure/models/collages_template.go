...
type CollagesTemplate struct {
	// ãƒ†ãƒ³ãƒ—ãƒ¬ãƒ¼ãƒˆID (UUID)
...
func (o *CollagesTemplate) GetTemplateCollageResults() CollageResultSlice {
	if o == nil {
		return nil
	}

	return o.R.GetTemplateCollageResults()
}
...
func (o *CollagesTemplate) GetTemplateTemplateParts() TemplatePartSlice {
	if o == nil {
		return nil
	}

	return o.R.GetTemplateTemplateParts()
}
